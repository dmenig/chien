...
class RememberMeMixin:
    def scrape_rememberme(self) -> List[Dict]:
        ...
        while True:
            ...
            if page > 1:
                url = (
                    f"https://remembermefrance.org/pets/page/{page}/?breed=chiot&pets_search%5Bsexe%5D=all&pets_search%5Bou_est_le_chien%5D=En+Roumanie&pets_search%5Burgence%5D=all"
                )
    ...
    def extract_dog_info_rememberme(self, article_soup: BeautifulSoup) -> Optional[Dict]:
        try:
